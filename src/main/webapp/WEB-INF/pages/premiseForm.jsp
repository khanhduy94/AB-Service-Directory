...
<title>Premise Information</title>
<!-- Bootstrap CSS -->
...
<body class=".container-fluid" onload="focusToEndPremiseName();">
	...
	<div class="container myrow-container">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form:form id="addPremiseForm" cssClass="form-horizontal"
					modelAttribute="premise" method="post" action="savePremise">

					<!-- Premise name: -->
					<div class="form-group">
						<div class="control-label col-xs-3">
							<form:label path="preName">Name:</form:label>
						</div>
						<div class="col-xs-6">
							<form:hidden path="id" value="${premiseObject.id}" />
							<form:input name="idName" cssClass="form-control"
								path="preName" placeholder="Enter Name"
								value="${premiseObject.preName}" />
						</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<form:input name="idPhone" cssClass="form-control" path="phone"
								placeholder="Enter Phone" value="${premiseObject.phone}" />
						</div>
					...
					<div class="form-group">
						...
						<div class="col-xs-6">
							<form:input name="idEmail" cssClass="form-control" path="email"
								placeholder="Enter Email" value="${premiseObject.email}" />
						</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-xs-5">
								<input type="submit" id="savePremise" class="btn btn-primary"
									value="Save" onclick="return submitPremiseForm();" />
	...
	<script type="text/javascript">
		...
		cancel.onclick = function() {
			window.location.href = "getAllPremises";
		};

		function focusToEndPremiseName() {
			$("#preName").focus();
			var text = $("#preName").val();
			document.getElementById("preName").setSelectionRange(
	...
	<script type="text/javascript">
		...
		function submitPremiseForm() {

			// getting the premise form values
			var name = $('#preName').val().trim();
